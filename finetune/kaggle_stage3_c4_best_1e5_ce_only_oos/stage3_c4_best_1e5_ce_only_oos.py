"""13-date OOS for this Stage3 1e-5 round's best: seg15 == last.

Does not re-run C2 init (0.1844), C2-kernel best (0.1836), C4 best (0.1792),
or P0a last (0.0643).
"""
import gc
import hashlib
...
SOURCE_COMMIT = "75831271790e26b18d96bd670426dd27a54a47a6"
OUTPUT = Path("/kaggle/working/kronos_small_0_1_stage3_c4_best_1e5_ce_only_oos")
...
def clone_source():
    for attempt in range(1, 4):
        repo = Path(tempfile.mkdtemp(prefix="kronos-stage3-1e5-oos-")) / "repo"
        try:
