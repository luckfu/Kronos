...
PARENT_RUN="$BASE/runs/beta_v1_3_best343_aggressive_1e5_twopass_seed100"
PARENT_OUTPUT="$PARENT_RUN/outputs/models/a_share_beta_v1_3_best343_aggressive_1e5_twopass_120d_to_10d"
PARENT_ROOT="$PARENT_OUTPUT/checkpoints/best_model"
TOKENIZER_ROOT="$BASE/models/tokenizer"
RUN_ROOT="$BASE/runs/beta_v1_3_2_symbol_holdout_90_10_aggressive_1e5_twopass_seed100"
OUTPUT_NAME="a_share_beta_v1_3_2_symbol_holdout_90_10_aggressive_1e5_twopass_120d_to_10d"
OUTPUT_ROOT="$RUN_ROOT/outputs/models/$OUTPUT_NAME"
PYTHON=(sudo -n -E "$BASE/env/a800-py312/bin/python")

DATA_MANIFEST_SHA="17afbeede658c13787043e601aa355717dda4d11719b51fb3ce368fb138e627a"
...
PARENT_SHA="ad6f2ffc84536795a5c88e0dfa74d5486aa720a2296bce4f669ff5e99bc8ed6a"
...
verify_sha "$DATA_MANIFEST_SHA" "$DATA_ROOT/data_manifest.json" "data manifest"
...
verify_sha "$PARENT_SHA" "$PARENT_ROOT/model.safetensors" "Beta v1.3.1 Best@895"
...
{
  "stage_id": "beta_v1_3_2_symbol_holdout_90_10_aggressive_1e5_twopass",
  "parent": {"release": "Beta v1.3.1", "checkpoint": "Best@895", "path": "$PARENT_ROOT", "model_sha256": "$PARENT_SHA", "old_tuning_loss": 2.3491287231445312},
  "initialization": {"model": "weights_only", "optimizer": "fresh", "scheduler": "one_cycle", "conditioning": "preserved"},
  "data": {"split": "symbol_holdout_90_10", "train_symbols": 4678, "validation_symbols": 520, "symbol_overlap": 0, "train_windows": 9457646, "manifest_sha256": "$DATA_MANIFEST_SHA"},
...
export KRONOS_DATA_MANIFEST_SHA256="$DATA_MANIFEST_SHA"
...
echo "[$(date -u +%FT%TZ)] mode=$MODE parent=Beta-v1.3.1-Best@895 split=symbol-holdout-90-10 coverage=2 peak_lr=1e-5 validation=full-only-123982-every-segment" | tee -a "$RUN_ROOT/launcher.log"
