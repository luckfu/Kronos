...
PARENT_ROOT="$PARENT_RUN/outputs/models/a_share_beta_v1_3_best343_aggressive_1e5_twopass_120d_to_10d/checkpoints/best_model"
TOKENIZER_ROOT="$BASE/models/tokenizer"
RUN_ROOT="$BASE/runs/beta_v1_3_2_symbol_holdout_90_10_aggressive_1e5_twopass_seed100"
OUTPUT="$RUN_ROOT/baseline_beta_v1_3_1_best895_symbol_holdout_full.json"
