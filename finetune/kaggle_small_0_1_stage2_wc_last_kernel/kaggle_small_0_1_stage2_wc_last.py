...
state_paths = sorted(
    input_root.glob("**/small_0.1_stage2_extend_01/checkpoints/last_model/model.safetensors")
)
if len(state_paths) != 1:
    raise RuntimeError(
        f"Expected one C2 last_model, found {len(state_paths)}: {state_paths}"
    )
...
print(
    {
        ...
        "initialization": "c2_last_model_fresh_optimizer",
