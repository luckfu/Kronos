"""Stage3 freeze probe B: train dependency_layer only from C2 best, 5 segments."""
import hashlib
import json
import os
...
COMMIT = '2970afa2e0ef726ae039113db9e0d266b38d10c6'
...
def main():
    os.environ.update(
        ...
        STAGE3_SWANLAB_RUN_ID='small_0.1_stage3_freeze_probe_b_dep_layer_from_c2_best_v1',
    ...
    log('started', source_commit=COMMIT, segments=5, lambda_path=0, ce_rank=True,
        lambda_rank=0, history_weight=0.02, trainable_mask='dependency_layer',
        milestone_segments='1,3,5',
        run_id='small_0.1_stage3_freeze_probe_b_dep_layer_from_c2_best_v1',
