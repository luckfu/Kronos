#!/usr/bin/env bash
# Short, single-GPU diagnostic: favor the ten-day objective and disable conditioning.
set -euo pipefail
...
RUN_ROOT="$BASE/runs/last1058_late10_no_condition_40_seed100"
OUTPUT_ROOT="$RUN_ROOT/outputs/models/a_share_v1_beta_last1058_late10_no_condition_40"
...
{
  "stage_id": "v1_beta_last1058_late10_no_condition_40_a800_v1",
  ...
  "validation": {"profile": "natural_only", "manifest_sha256": "$NATURAL_SHA", "quick_samples": 3000, "large_samples": 12000},
  "training": {"segments": 40, "seed": 100, "single_gpu": 0, "fresh_optimizer": true, "condition_inputs": "disabled", "forecast_horizon_weights": [0.5, 0.5, 0.5, 0.5, 0.5, 1.0, 1.0, 1.0, 1.0, 4.0]}
}
EOF
...
export KRONOS_VALIDATION_QUICK_SAMPLES=3000 KRONOS_VALIDATION_LARGE_SAMPLES=12000
...
export KRONOS_PREDICTOR_SAVE_FOLDER="a_share_v1_beta_last1058_late10_no_condition_40"
export KRONOS_LOOKBACK_WINDOW=120 KRONOS_PREDICT_WINDOW=10
export KRONOS_USE_SECTOR_FEATURES=1 KRONOS_USE_SIZE_FEATURES=0 KRONOS_USE_SIZE_PERCENTILE=1
export KRONOS_DISABLE_CONDITION_INPUTS=1
export KRONOS_NUM_SECTORS=86 KRONOS_NUM_SIZE_BUCKETS=0 KRONOS_CONTEXT_LAYER=10
export KRONOS_TRAIN_SIGNAL_START=2015-01-01 KRONOS_TRAIN_SIGNAL_END=2026-07-17
export KRONOS_VAL_SIGNAL_START=2026-01-01 KRONOS_VAL_SIGNAL_END=2026-07-17
export KRONOS_TRAIN_SAMPLES_PER_SEGMENT=20000 KRONOS_VALIDATION_SAMPLES=12000
export KRONOS_EPOCHS=40 KRONOS_COVERAGE_PASSES=1 KRONOS_REQUIRE_FULL_COVERAGE=0
export KRONOS_EARLY_STOPPING_PATIENCE=0 KRONOS_MAX_SEGMENTS_PER_RUN=40 KRONOS_RESUME_TRAINING=0
export KRONOS_PREDICTOR_LEARNING_RATE=1e-6 KRONOS_CONDITION_LEARNING_RATE=1e-6
export KRONOS_SCHEDULER=uniform_cosine KRONOS_SCHEDULER_MIN_LR=2e-7
export KRONOS_PREDICTOR_MIN_LR=2e-7 KRONOS_CONDITION_MIN_LR=2e-7
export KRONOS_SCHEDULER_WARMUP_RATIO=0.01 KRONOS_PREDICTOR_WARMUP_START_LR=5e-7
export KRONOS_CONDITION_WARMUP_START_LR=5e-7
export KRONOS_PREDICTOR_LOSS_MODE=forecast KRONOS_HISTORY_LOSS_WEIGHT=0.02
export KRONOS_FORECAST_HORIZON_WEIGHTS="0.5,0.5,0.5,0.5,0.5,1,1,1,1,4"
export KRONOS_TRAINABLE_TRANSFORMER_LAYERS=2 KRONOS_ADAM_WEIGHT_DECAY=0.1
export KRONOS_GRAD_CLIP_NORM=1.0 KRONOS_CONDITION_MONITOR_INTERVAL_STEPS=100
export KRONOS_CONDITION_ABLATION_INTERVAL_SEGMENTS=0 KRONOS_BATCH_SIZE=32 KRONOS_NUM_WORKERS=2
export KRONOS_USE_AMP=1 KRONOS_BOOTSTRAP_COMPLETED_SEGMENTS=0

echo "[$(date -u +%FT%TZ)] starting natural-only late10 no-condition diagnostic" | tee -a "$RUN_ROOT/launcher.log"
